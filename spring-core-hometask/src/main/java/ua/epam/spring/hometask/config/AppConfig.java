...
public class AppConfig {
  ...
  public Auditorium auditoriumOne() {
    return createAuditorium(
        auditorium1Name, Long.parseLong(auditorium1NumOfSeats), auditorium1VipSeats);
  }

  @Bean
  public Auditorium auditoriumTwo() {
    return createAuditorium(
        auditorium2Name, Long.parseLong(auditorium2NumOfSeats), auditorium2VipSeats);
  }

  @Bean
  public Auditorium auditoriumThree() {
    return createAuditorium(
        auditorium3Name, Long.parseLong(auditorium3NumOfSeats), auditorium3VipSeats);
  }
